...
const submit = () => {
    form.post(route('coordinator.stores.store'));
};
</script>

<template>
    <AppLayout title="Tambah Toko / Gudang (CSA)">
        <Head title="Tambah Toko / Gudang (CSA) — Koordinator" />

        <div class="mb-6">
            <div class="flex items-center gap-2 text-xs text-gray-500 mb-1">
                <Link :href="route('coordinator.stores.index')" class="hover:text-blue-600">Stores</Link>
                <span>/</span>
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="2"
                        placeholder="Alamat fisik unit toko / gudang..."
                        class="w-full text-xs rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                    ></textarea>
                </div>
