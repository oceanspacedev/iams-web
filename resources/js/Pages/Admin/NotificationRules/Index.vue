            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-xs">
                    <thead class="bg-gray-50 text-gray-600 uppercase text-[10px] tracking-wider border-b border-gray-200">
                        <tr>
                            <th class="px-5 py-3.5 whitespace-nowrap">Nama Aturan</th>
                            <th class="px-5 py-3.5 whitespace-nowrap">Waktu Pengiriman (Days Before)</th>
                            <th class="px-5 py-3.5 whitespace-nowrap">Jam Pengiriman</th>
                            <th class="px-5 py-3.5 whitespace-nowrap">Channel</th>
                            <th class="px-5 py-3.5 whitespace-nowrap">Penerima</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr v-for="rule in rules" :key="rule.id" class="hover:bg-gray-50/70">
                            ...
                            <td class="px-5 py-3.5 font-mono text-gray-800">
                                {{ rule.send_time }} WIB
                            </td>
                            <td class="px-5 py-3.5">
                                <span
                                    ...
                                    :class="{
                                        ...
                                        'bg-purple-50 text-purple-700 border-purple-200': rule.channel === 'dashboard',
                                    }"
                                >
                                    {{ rule.channel }}
                                </span>
                            ...
                            <td class="px-5 py-3.5 text-gray-600">
                                <span v-if="rule.recipient_type === 'all'">Semua (Toko & Auditor)</span>
                                <span v-else-if="rule.recipient_type === 'auditee'">Auditee Toko</span>
                                <span v-else-if="rule.recipient_type === 'auditor'">Auditor Lapangan</span>
                                <span v-else>{{ rule.recipient_type }}</span>
                            </td>
                            <td class="px-5 py-3.5 whitespace-nowrap">
                                <button
                                    @click="toggleActive(rule)"
                                    type="button"
                                    class="inline-flex items-center px-2 py-0.5 rounded text-[11px] font-medium border transition-colors"
                                    :class="rule.is_active ? 'bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100' : 'bg-gray-100 text-gray-500 border-gray-200 hover:bg-gray-200'"
                                >
